...
@interface SubjectViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UIScrollViewDelegate>
{
...
- (void)getNewProductFromNet
{
    ...
    [[HttpreQuestManager shareInstance]getSubjectWithproductSysNo:[self.sysNo intValue] Page:_page success:^(id responseObject) {
...
//{
//    return CGSizeMake(self.view.frame.size.width/2.05, self.view.frame.size.height/2.272);
//}
